export default function Hero() {
    return <section className="lg:py-20 sm:py-8 ">
        <div className="container items-center max-w-6xl px-4 px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div className="flex flex-wrap items-center -mx-3">
                <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div className="w-full lg:max-w-md">
                        <h2 className="mb-4 text-3xl font-bold leading-tight tracking-tight sm:text-4xl font-heading dark:text-gray-100">我叫 Bysir</h2>
                        <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">从事编程工作的社畜，我正专注于：</p>
                        <ul>
                            <li className="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span className="font-medium text-gray-500">后端开发（优雅与效率）</span>
                            </li>
                            <li className="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span
                                    className="font-medium text-gray-500">前端（Just for fun）</span>
                            </li>
                            <li className="flex items-center py-2 space-x-4 xl:py-3">
                                ...
                                <span
                                    className="font-medium text-gray-500">带娃</span>
                            </li>
                        </ul>
                    </div>
                </div>
