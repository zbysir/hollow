            ...
            <div className="flex flex-wrap items-center -mx-3">
                <div className="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div className="w-full lg:max-w-md">
                        ...
                        <p className="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">正在从事编程工作的社畜，我正专注于:</p>
                        <ul>
                            ...
                            {/*    </svg>*/}
                            {/*    <span*/}
                            {/*        className="font-medium text-gray-500">100% Protection and Security for Your App</span>*/}
                            {/*</li>*/}
                        </ul>
                    </div>
                </div>
